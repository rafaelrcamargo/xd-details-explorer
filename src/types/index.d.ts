...
declare global {
  ...
  interface SceneNodeList {
    ...
    forEach(callback: (sceneNode: SceneNode, index: number) => void, thisArg?: object): void

    forEachRight(callback: (sceneNode: SceneNode, index: number) => void, thisArg?: object): void

    filter(callback: (sceneNode: SceneNode, index: number) => boolean, thisArg?: object): Array<SceneNode>

    map(callback: (sceneNode: SceneNode, index: number) => any, thisArg?: object): Array<any>

    some(callback: (sceneNode: SceneNode, index: number) => boolean, thisArg?: object): boolean
